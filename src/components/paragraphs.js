    ...
    '안드로이드': {
      'AI의 개인 정보 수집': {
        ...
        agree: [
          ...
          {
            main:
              ' 개인 정보 수집 업데이트 기능을 유지하는 것이 좋을까요? '
          },
        ],
        disagree: [
            {
            ...
            { 
                main:
                 '   요양 보호사 K씨가 매번 어머니의 식단이나 생활 정보를 입력하는 시스템이 번거롭기도 하고요.\n ' 
            },
            { 
                main: 
            ...
            {
                main: 
                ' 개인 정보 수집 업데이트에 동의를 하는 편이 좋을까요?'
            }
        ],
        ending1:[
            {
                main: 
                '우리 가족은 최종적으로  개인정보 제공에 동의하였고, 사생활 관련한 약간의 불편함을 감수하며 보다 향상된 서비스를 이용하게 되었습니다. \n \n' + 
      ...
      '안드로이드의 감정 표현': {
        ...
        disagree:
            [
                ...
                {
                    main: 
                    '  	우리 가족도 감정 엔진 업데이트에 동의하는 것이 좋을까요?'
                }
            ],
        ending1: [
            {
                main: '우리 가족은 최종적으로  감정 업데이트에 동의하였고, Homemate(과/와) 더욱 친밀한 교류를 이어나가게 되었습니다.\n\n'  
        ...
        ending2: [
            {
                main: '우리 가족은 최종적으로 감정 업데이트에 동의하지 않았고, Homemate(은/는) 감정적 교류가 아닌 다른 방법으로 우리 가족을 돕고 있습니다. \n\n' +
                '우리 가족과 Homemate의 관계를 위해 여러분은 어떤 가치를 택하고, 무엇을 포기했나요? '
            }
        ]
      },
      '아이들을 위한 서비스': 
        {
            ...
            {
                main: 
                '   이러한 상황에서, 가정용 로봇과 아동의 상호작용을 제한하는 연령 규제가 필요할까요?'
            }
              ],
        ...
        agree:  [
            {
                main: 
                '   회의에서는 1차적으로 다수의 결정으로 연령 규제를 하였습니다.'
            },
            { 
                main:
        ...
        ending1: [
            {
                main: 
                ' 본 회의에서는 가정용 로봇 사용에 연령 제한을 두기로 했습니다. 이후 아이들을 타깃으로 한 많은 서비스가 중단되었고, 몇몇 전문가들은 전체 세대의 사회성 발달을 고려하여 이 결정을 환영했습니다.\n\n' +
      ...
      '지구, 인간, AI': 
        {
            ...
            { 
                main: 
                '  	또한, 서비스가 업그레이드 될수록 소비량은 점점 증가하고 있습니다.이는 서비스가 업그레이드 될수록 더 점점 심각해지고 있습니다. '
            },
            {
                main: 
        ...
        agree:  [
            {
                main: 
                '  	회의에서는 1차적으로 다수의 결정으로 가정용 로봇의 업그레이드 및 사용에 제한을 두게 되었습니다.	'
            },
            { 
                main:
                '  	그로 인해, 환경 문제에 대한 우려는 일정부분 해소되었으나, 	'
            },
            { 
                main: 
                '  	기존에 HomeMate를 사용하던 사람들은 서비스의 제한으로 삶의 질이 떨어지고 있다며 불만을 제기하고 있으며,\n' + '  개발사 측에서도 수익이 떨어져 반발하고 있습니다.'
            },
            {
                main: 
