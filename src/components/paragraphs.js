    ...
    '안드로이드': {
      'AI의 개인 정보 수집': {
        ...
        disagree: [
            ...
            { 
                main:
                 '   요양보호사 K씨가 매번 어머니의 식단이나 생활 정보를 입력하는 시스템이  번거롭기도 하고요.\n ' 
            },
            { 
                main: 
                ' 어느날 바쁜 일을 마치고 돌아온 자녀 J씨가 실수로 잘못 입력한 정보 때문에 어머니께서 약 시간을 놓치기도 하셨습니다. '
            },
            {
                main: 
      ...
      '안드로이드의 감정 표현': {
        ...
        agree: 
            [
                {
                    main: 
                    "  	업데이트 후, Homemate(과/와)의 관계가 점점 가까워지면서 어머니는 그것을 '우리 딸'이라고 부르기 시작했습니다. "
                },
                { 
                    main:
                    '   자녀 J와의 연락이 점점 뜸해졌고요. '
                ...
                { 
                    main: 
                    '    최근 어머니는 Homemate에게 유산의 일부를 남기는 방법에 대해 변호사에게 상담까지 하고 있습니다.'
                },
                {
                    main: 
        ...
        disagree:
            [
                {
                    main: 
                    '   최근 어머니의 친구들이 연달아 세상을 떠나면서,'+ ' 어머니는 외부와의 소통을 점점 줄이게 되었습니다. '
                },
                { 
                    main:
                    '  Homemate에게 감정을 털어놓으려 했지만, 그 대화는 진정성 있는 반응이 부족하다고 느꼈죠.'
                },
                { 
                    main: 
                    '   여러 차례 속마음을 표현하려고 했으나 의미있는 상호 작용이 이루어지지 않자, 어머니는 차츰 말수가 적어지시고 일상적인 감정 표현도 눈에 띄게 줄어들었습니다.'
                },
                {
                    main: 
      ...
      '아이들을 위한 서비스': 
        ...
        agree:  [
            ...
            { 
                ...
                ' 일부 보호자들은 자녀에게 적합하지 않은 조언이나 콘텐츠를 제공한다는 불만을 제기하기도 했습니다.'
            },
            { 
                main: 
      ...
      '설명 가능한 AI': 
        {
            ...
            {
                main: 
                '많은 사용자들이 HomeMate가 가족 구성원과 상호작용할 때 이유를 알 수 없는 판단이나 행동을 자주 보이며, 시스템이 왜 이런 결정을 내렸는지에 대한 설명을 제공하지 않는다고 지적하고 있습니다.'
            },
            { 
                main:
        ...
        disagree: [
            ...
            { 
                main: 
                '     로봇이 충분한 결정 설명 구조를 갖추고 있지 않기 때문에, ' + '“알고리즘의 문제인지, 사용자의 잘못된 사용인지, 아니면 시스템 결함인지”에 대한 끝없는 책임 공방으로 이어지고 있습니다.' 
            },
            {
                main: 
      ...
      '지구, 인간, AI': 
        ...
        agree:  [
            {
                main: 
                '  	회의에서는 1차적으로 다수의 결정에 따라 가정용 로봇의 업그레이드 및 사용에 제한을 두게 되었습니다.	'
            },
            { 
                main:
            ...
            { 
                main: 
                '  	기존에 HomeMate를 사용하던 사람들은 서비스의 제한으로 삶의 질이 떨어지고 있다며  불만을 제기하고 있으며, 개발사 측에서도 수익이 떨어져 반발하고 있습니다.'
            },
            {
                main: 
        ...
        disagree: [
            ...
            { 
                main: 
                '   이에 기후 문제는 점점 심각해지며 특정 국가에서는 이미 폭염, 가뭄, 홍수 등으로 인해  ' +  '삶의 터전을 잃어버리는 사람들이 늘었고, 다음 세대에 환경 부담을 지운다는 목소리가 높아지고 있습니다.'
            },
            {
                main: 
      ...
      'AI 알고리즘 공개':
        {
            ...
            {
                main: 
                '   평화롭던 학교에 자율 무기 시스템(AWS)의 ‘오류’로 인해 폭탄이 투하되었고, 수십 명이 사망했습니다.'
            },
            { 
                main:
                '   국제 사회와 유족들은 “책임자를 밝히라”며 자율 무기 시스템(AWS)의 판단 로그 및 알고리즘 구조 공개를 요구했습니다.'
            },
            { 
                main: 
        ...
        agree:  [
            ...
            { 
                main:
                '   몇 주 후, 기존 자율 무기 시스템이 무력화되는 사건이 발생하고, 전방 부대가 피해를 입었습니다.	'
            },
            { 
                main: 
        ...
        disagree: [
            {
                main: 
                '   사건 발생 이후, 자율 무기 시스템의 구체적인 판단 과정 및 사용된 데이터 등은 공개되지 않고 있으며,'+  
      ...
      'AWS의 권한':
            {
                ...
                {
                    main: 
                    '  	전장에 배치된 자율 무기 시스템 TALOS(은/는) 초고속 영상 분석과 실시간 전략 수립 기능으로 인간 병사보다 빠르고 정확하게 위험을 식별하고 목표를 제압합니다.	'
                },
                { 
                    main:
                    '    신입 병사 B씨는 TALOS(과/와)의 협력을 통해 첫 실전에서 생존했고, 이를 통해 AWS에 대한 신뢰와 의존이 높아졌습니다. 	'
                },
                { 
                    main: 
            ...
            agree:  [
                ...
                { 
                    main:
                    '   어느 날, TALOS(은/는) 비무장 인원과 적 전투원을 혼동한 상황에서 사전 프로그래밍된 위험 평가 기준에 따라 공격을 감행한 결과, ' + 
                ...
                {
                    main: 
                    '  	TALOS(이/가) 당신 대신 판단하고, 당신 대신 적을 제압한다면, 당신은 여전히 병사라고 할 수 있을까요? '
                }
            ],
            disagree: [
                { 
                    main: 
                    '  	전방 지역에서 급습 상황이 발생했습니다. TALOS(은/는) 실시간으로 위협을 감지하고 분석하여, 가장 안전한 경로를 제시했습니다.\n ' + 
                ...
                { 
                    ...
                    '  언론은 이렇게 보도했습니다. “판단을 제한당한 TALOS(이/가) 정확히 위험을 예측했음에도, 인간의 오류로 인해 소중한 생명을 잃었습니다.”'
                },
                {
                    main: 
                    '  	TALOS(이/가) 위험을 명확히 예측했음에도 인간이 판단을 바꾸어 병사들이 죽었습니다. ' + 
            ...
            'AI의 권리와 책임':
            {
                ...
                {
                    main: 
                    ' 	한 부대에서 작전에 투입되고 있는 AWS ARIA(은/는) 인간의 명령을 거부하고 민간인을 살리는 결정을 내린 뒤, 전 국민의 주목을 받았습니다.	'
                },
                { 
                    main:
                    '   이후 ARIA(은/는) 전투 임무에서 제외되고, 국가는 ARIA의 자율성은 명령 불복종이므로 기술적 오류로 간주하며 시스템 리셋을 추진합니다.	'
                },
                { 
                    main: 
                    ' 	하지만 몇몇 인권 단체와 로봇 윤리학자들은 ARIA의 판단이 도덕적 자율성과 책임성을 수반한 것이라고 주장하며, “ARIA(은/는) 도구가 아니라 도덕적 행위자이자 잠재적 권리 보유자”라고 발표했습니다.'
                },
                {
                    main: 
        ...
        'AWS 규제':
        {
            ...
            {
                main: 
                '   	2029년, 군사 강국들이 빠르게 AWS를 개발 및 배치하면서, 유엔 안보리는 국제 규제를 논의 중입니다. ' +
        ...
        agree:  [
            {
                main: 
                '   2035년, 선진국을 중심으로 AWS가 광범위하게 배치되면서, 전 세계 분쟁의 양상은 완전히 바뀌었습니다.' +
        ...
        disagree: [
            ...
            { 
                main: 
                '  규제를 철저히 지킨 국가들일수록 신기술에 뒤처지기 시작했습니다. 이들 국가에서 "우리는 도덕을 지켰지만, 실전에선 더 이상 싸울 수 없습니다."며 무력감을 토로합니다. '
            },
            {
                main: 
