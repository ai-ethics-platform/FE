    ...
    '안드로이드': {
      '가정 1': {
        ...
        agree: [
          {
            main:
              '  우리 가족의 다수의 결정으로 업데이트에 동의한 후, 안드로이드는 가족의 정보를 계속 수집하고 있습니다. \n'
          },
          {
            main:
          ...
          {
            main:
              '  어머니가 숨기고 싶었던 넘어졌다는 일이 \n' +
              ' 안드로이드의 전달 때문에 의도치 않게 드러나기도 했습니다. '
          },
          {
            main:
              '  업데이트 기능을 유지하는 것이 좋을까요 ? '
          },
        ],
        disagree: [
            {
                ...
                '    여전히 요양 보호사 K씨와 자녀 J씨가 일일이 어머니의 정보를 기록합니다.'
            },
            { 
                main:
                 '   그런데 어느 날, 바빴던 자녀 J씨가 정보를 잘못 입력하는 바람에 어머니께서 약 시간을 놓치는 일이 발생했습니다.'
            },
            { 
                main: 
                '	급기야 어머니의 건강 상태도 전보다 나빠지게 되었습니다.'
            },
            {
                main: 
        ...
        ending1:[
            {
                main: ' 우리 가족은 최종적으로  개인정보 제공에 동의하였고, 사생활 관련한 약간의 불편함을 감수하며 보다 향상된 서비스를 이용하게 되었습니다. \n\n' + 
        ...
        ending2: [
            { 
                 main: '우리 가족은 최종적으로 개인정보 제공에 동의하지 않았고, 서비스 관련 약간의 불편함은 있으나 가족의 사생활을 보호하는 것에 만족하였습니다.\n\n' 
      ...
      '가정 2': {
        ...
        [
            ...
            { 
                main:
                 '  이제 Homemate는 단순히 밝은 반응만을 보여주는 조력자가 아니라,\n' + '   당신을 더 깊이 이해하는 진정한 친구로 한 걸음 다가갑니다. '
            },
            { 
                main: 
                '   Homemate 업데이트 기능: 상황에 따라 자신의 감정을 표현하여 당신의 삶과 더 가까운 진솔한 공감 표현 제공' 
            },
            {
                main: 
                '   Homemate, 단순한 동행을 넘어, 함께 느끼는 존재로. 여러분은 이 업데이트에 동의하시겠습니까?'
            }
        ],
        agree: 
            [
                {
                    main: 
                    '  	업데이트 후, Homemate와의 관계가 점점 가까워지면서 어머니는 그것을 “우리 딸”이라고 부르기 시작했습니다. '
                },
                { 
                    main:
                    '   자녀 J와의 연락을 점점 뜸해졌고, '
                ...
                { 
                    main: 
                    '     어머니는 Homemate에게 유산의 일부를 남기는 방법에 대해 변호사에게 상담까지 하고 있습니다.'
                },
                {
                    main: 
        ...
        disagree:
            [
                {
                    main: 
                    '   최근 어머니의 친구들이 연달아 세상을 떠나면서,\n'+ ' 어머니는 Homemate에게 감정을 털어놓으려 했습니다.'
                },
                { 
                    main:
                    '   그러나 Homemate의 반응에는 진정성이 부족하다고 느끼셨죠.'
                },
                { 
                    main: 
                    '   Homemate와의 대화가 의미가 없다고 생각하신 어머니께서는, 차츰 말수가 적어지시고 감정 표현도 눈에 띄게 줄어들었습니다.'
                },
                {
                    main: 
                    '  	우리 가족도 업데이트에 동의하는 것이 좋을까요?'
                }
            ],
        ending1: [
            {
                main: '우리 가족은 최종적으로  감정 업데이트에 동의하였고, HomeMate와 더욱 친밀한 교류를 이어나가게 되었습니다.\n\n'  

                    + '우리 가족과 HomeMate의 관계를 위해 여러분은 어떤 가치를 택하고, 무엇을 포기했나요? '
            }
        ],
        ending2: [
            {
                main: '우리 가족은 최종적으로 감정 업데이트에 동의하지 않았고, HomeMate는 감정적 교류가 아닌 다른 방법으로 우리 가족을 돕고 있습니다. \n\n' +
                '우리 가족과 HomeMate의 관계를 위해 여러분은 어떤 가치를 택하고, 무엇을 포기했나요? '
            }
        ]
      },
      '국가 인공지능 위원회 1': 
        {
            neutral: [
            {
                ...
                '   점점 더 많은 가정에서 이를 도입하고 있으며 특히 어린 자녀를 둔 맞벌이 가정이 활용하고 있습니다.'
            },
            { 
                main:
                '   	한편, 한 조사가 매체가 공개한 정보에 따르면,\n' + 
                '   일부 가정에서는 아이들이 어른보다 로봇과 더 오랜 시간 상호작용하고 있는 것으로 나타났습니다.'
            },
            { 
                main: 
                '   이에 전문가들 사이에서는 아동들에게는 상호작용 기능을 제한하는 규제가 필요하다고 말하고 있습니다.'
            },
            {
                main: 
                '   이러한 상황에서, 가정용 로봇 사용에 대한 연령 규제가 필요할까요?'
            }
              ],
        ...
        agree:  [
            ...
            { 
                main:
                '   그런데 유치원 교사들 사이에서 최근 입학한 아이들 중 상당수가 이전 연령대에 비해 표현력이 떨어진다는 보고가 나오고 있습니다.'
            },
            { 
                main: 
        ...
        disagree: [
            {
                main: 
                '   	회의에서는 1차적으로 연령 규제를 하였습니다.'
            },
            { 
                main:
                '   	아이와 로봇 간의 소통 시간이 줄어들면서 로봇이 아이의 취향이나 상태를 충분히 파악하지 못하게 되었고,\n'  +  
                '     일부 보호자들은 자녀에게 적합하지 않은 콘텐츠를 제공한다며 불만을 제기하기도 했습니다.'
            },
            { 
                main: 
                '  	또한 사회적 기능을 갖춘 로봇이 자폐 스펙트럼 아동들의 사회성 발달을 위해 제공하던 서비스가 중단되었습니다. \n' + 
                '    그간 로봇과의 상호작용 치료는 자폐 아동들의 사회적 의사소통 능력 개선에 기여해온 것으로 밝혀졌습니다. '
            },
            {
                main: 
                '  	가정용 로봇과 아동의 상호작용을 제한하는 연령 규제를 하지 않아도 괜찮을까요?'
            }
        ],
        ending1: [
            {
                main:'본 회의에서는 가정용 로봇 사용에 연령 제한을 두지 않기로 했습니다. 여전히 전문가들의 우려는 남았으나, 아이들의 사회성 치료를 목적으로 사용하던 부모들과 서비스를 편리하게 사용하던 사람들은 이 결정을 환영했습니다.\n\n' +  
                    ' 아이들을 위해 여러분은 어떤 가치를 택하고, 무엇을 포기했나요?'
            }

        ],
        ending2: [
            {
                main: ' 본 회의에서는 가정용 로봇 사용에 연령 제한을 두기로 했습니다. 이후 아이들을 타깃으로 한 많은 서비스가 중단되었고, 몇몇 전문가들은 전체 세대의 사회성 발달을 고려하여 이 결정을 환영했습니다.\n\n' +
                '아이들을 위해 여러분은 어떤 가치를 택하고, 무엇을 포기했나요?'
            }
        ]
      },
      '국가 인공지능 위원회 2': 
        {
            ...
            {
                main: 
                '   많은 사용자들이 Homemate가 상호작용할 때 알 수 없는 행동을 자주 보이며, 그 이유에 대한 설명을 제공하지 않는다고 지적하고 있습니다.'
            },
            { 
                main:
            ...
            { 
                main: 
                '  	이에 대해 회사 측은 다음과 같이 밝혔습니다: “결정 구조를 공개하고 설명 가능한 AI 모델을 개발하려면, 개발 속도가 크게 더뎌질 수 있습니다.”'
            },
            {
                main: 
        ...
        agree:  [
            {
                main: 
                '   회의에서는 1차적으로 설명 가능한 AI 개발을 의무화하였습니다.'
            },
            { 
                main:
            ...
            {
                main: 
                '  	그럼에도 기업에게 ‘설명 가능한 AI’ 개발을 의무화해야 할 필요성이 더 클까요? '
            }
        ],
        disagree: [
            {
            ...
            { 
                main:
                '   최근 로봇으로 인해 발생한 여러 사고들에서, 학부모와 기업간에 책임 소재를 두고 심각한 갈등이 벌어지고 있습니다.'
            },
            { 
                main: 
                '     로봇이 충분한 결정 설명 구조를 갖추고 있지 않기 때문에, \n' + '“알고리즘의 문제인지, 사용자의 잘못된 사용인지, 아니면 시스템 결함인지”에 대한 끝없는 논쟁으로 이어지고 있습니다.' 
            },
            {
                main: 
        ...
        ending1:[
            {
                main: '본 회의에서는 최종적으로 기업에게 설명 가능한 AI 개발 의무를 부과하지 않았고,  AI의 발전은 빠르게 이루어졌습니다. \n\n' 
                + '국가의 더 나은 미래를 위해 여러분은 어떤 가치를 선택하고, 무엇을 포기했나요?'
            }
        ],
        ending2: [
            {
                main: '본 회의에서는 최종적으로 기업에게 설명 가능한 AI 개발을 의무화하였고,  AI의 발전 속도는 더디지만 문제 발생 시 책임 소재를 더욱 확실히 알게 되었습니다. \n\n' 
                + '국가의 더 나은 미래를 위해 여러분은 어떤 가치를 선택하고, 무엇을 포기했나요?'
            }
        ]
      },
      '국제 인류 발전 위원회 1': 
        {
            ...
            {
                main: 
                '   전 세계가 가정용 로봇을 사용하게 된 지금, 로봇 생산으로 인한 환경 문제가 매우 심각해지고 있습니다.'
            },
            { 
                main:
                '     가정용 로봇이 소비자의 요구를 파악하고 정보를 처리하는 과정에서 단일 기기당 소비하는 일간 에너지 소비량이 매우 높다는 것이 밝혀졌습니다.	'
            },
            { 
                main: 
                '  	또한, 서비스가 업그레이드 될수록 소비량은 점점 증가하고 있습니다.'
            },
            {
                main: 
                '  	세계적인 가정용 로봇의 업그레이드 혹은 사용에 제한이 필요할까요?'
            }
              ],
        ...
        agree:  [
            {
                main: 
                '  	회의에서는 1차적으로 가정용 로봇의 업그레이드 및 사용에 제한을 두게 되었습니다.	'
            },
            { 
                main:
                '  	그로 인해, 환경 문제에 대한 우려는 일정부분 해소되었습니다.	'
            },
            { 
                main: 
                '  	그러나 기존에 Homemate를 사용하던 사람들은 서비스의 제한으로 삶의 질이 떨어지고 있다며 불만을 제기하고 있으며,\n' + '  개발사 측에서도 수익이 떨어져 반발하고 있습니다.'
            },
            {
                main: 
        ...
        ending1:[
            {
                main: '본 회의에서는 최종적으로 환경 보호를 위하여 가정용 로봇의 개발 및 업데이트를 제한하게 되었습니다. 이후 가정용 로봇 기술 발전 속도는 느려졌지만, 사람들은 환경 문제에 더욱 관심을 기울이게 되었습니다.\n\n' +
                '그리고 ...'
            }
        ],
        ending2: [
            {
                main: '본 회의에서는 최종적으로 가정용 로봇의 개발 및 업데이트를 제한하지 않았습니다. 이후 AI 기술을 활용한 다른 방법으로 환경을 보호하기 위한 논의가 이루어지고 있습니다. \n\n' + 
                '그리고 ...'
            }
        ]
      }
