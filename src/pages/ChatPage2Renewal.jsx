...
// Kept independent from ChatPage2 so renewal changes cannot alter the legacy flow.
...
export default function ChatPage2Renewal() {
...
keys.forEach((k) => {
  ...
  const handleExit = () => {
    ...
    navigate('/selectroom?isRenewal=true');
  };
