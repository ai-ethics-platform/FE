...
export default function Game03() {
  ...
  const handleContinue = () => {
    ...
    navigate('/game04', { state: { agreement, confidence } });
  };
    ...
    <Background bgIndex={3}>
      ...
      <div style={{ position: 'fixed', inset: 0, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', bottom: 80, left: '50%', transform: 'translateX(-50%)' }}>
          <Continue width={264} height={72} step={1} onClick={handleContinue} disabled={!agreement || confidence === 0} />
        </div>
      </div>
    </Background>
  );
