...
const AWS_TEXT =
 ...
 const TEACHER_TEXT = 
 ' 👋 안녕하세요! AI 윤리 딜레마 기반 대화형 게임에 오신 걸 환영합니다! \n\n 이 게임에서는 여러분이 AI 기술 때문에 \n 생길 수 있는 갈등 상황을 탐색하고,\n 스스로 판단하며 친구들과 함께 토론할 수 있어요. \n 게임은 이렇게 진행됩니다: \n \n  1️⃣ 먼저 각자 역할을 맡아 인물이 되어 보고, \n 2️⃣ AI 기술이 등장하는 실제 같은 상황을 만나고,\n 3️⃣ 스스로 어떤 선택을 할지 정한 뒤,\n 4️⃣ 마지막으로 친구들과 의견을 나누며 함께 결론을 만들어 갑니다.\n \n 자, 이제 시작해 볼까요?' ;
