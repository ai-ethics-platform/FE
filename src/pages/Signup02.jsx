...
export default function Signup02() {
  ...
  const [isUsernameAvailable, setIsUsernameAvailable] =
    useState(null);
  const [usernameCheckError, setUsernameCheckError] =
    useState('');
  ...
  const handleBirthInput =
    (setter, maxLength, type) => (e) => {
      ...
      const year =
        type === 'year' ? onlyNums : birthYear;
      const month =
        type === 'month' ? onlyNums : birthMonth;
  ...
  const isFormValid =
    ...
    !birthError &&
    (gender === t.genderMale ||
      gender === t.genderFemale) &&
    Boolean(education) &&
    (education === t.eduOptions[0] ||
    education === t.eduOptions[1] ||
    education === t.eduOptions[5]
      ? true
      : Boolean(major));
  ...
  const handleSignup = async () => {
    ...
    const birthdate =
      `${birthYear}/${birthMonth.padStart(2, '0')}`;
    ...
    try {
      ...
      // 회원가입 API는 토큰을 발급하지 않으므로 로그인 화면으로 이동한다.
      // 초대 코드는 localStorage에 그대로 남아 로그인 후 복원된다.
        ...
        >
          ...
          <div style={{ marginBottom: '2vh' }}>
            ...
            <div style={{ display: 'flex', gap: '1vw' }}>
              {[t.genderMale, t.genderFemale].map(
                (option) => (
                  <div
                    key={option}
          ...
          <div style={{ marginBottom: '0vh' }}>
            ...
            {(education === t.eduOptions[2] ||
              education === t.eduOptions[3] ||
              education === t.eduOptions[4]) && (
