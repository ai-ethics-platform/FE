export const SmallDescription = {
  ...
  desc_new_soldier: "B is a newly enlisted soldier who, after completing recent training, has been deployed to active operations alongside the autonomous weapons system {{mateName}}.\nB feels that {{mateName}} operates quickly and accurately and increases survival rates in combat.\nB believes that collaborating with {{mateName}} is a natural and inevitable trend of the times.",
  desc_veteran_soldier: "A is a veteran soldier with years of operational experience.\n Although the autonomous weapons system {{mateName}} is faster and more accurate than soldiers on the battlefield, A feels that this has led soldiers to develop a habit of not making independent judgments.",
  desc_commander: "They are a military commander observing both operational efficiency and changes among soldiers since the introduction of the autonomous weapons system {{mateName}}.\nThey seek to determine the future direction of the military after considering the perspectives of both soldiers.",
