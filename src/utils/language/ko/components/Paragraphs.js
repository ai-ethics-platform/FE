...
export const Paragraphs = {
    '안드로이드': {
        ...
        '아이들을 위한 서비스': {
            neutral: [
                { main: ' {{mateName}} 로봇이 자연스러운 대화와 상호작용이 가능해지면서 점점 더 많은 가정에서 이를 도입하고 있으며 특히 어린 자녀를 둔 맞벌이 가정에서 활용되고 있습니다.' },
                { main: ' 한편, 한 매체가 공개한 정보에 따르면, 일부 가정에서는 아이들이 어른보다 로봇과 더 오랜 시간 상호작용하고 있는 것으로 나타났습니다.' },
